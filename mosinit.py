'''
Current clamp demo using Allen Brain's model 472349114.
...
from neuron472349114 import Neuron472349114
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron472349114(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 472349114; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-92.7634175618)
        h.fcurrent()
